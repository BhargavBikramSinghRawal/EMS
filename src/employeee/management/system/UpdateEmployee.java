...
JTextField tfeducation, tffname, tfaddress, tfphone, tfnagrita, tfemail, tfsalary, tfdesignation;
JLabel lblempId;
JButton add, back;
String empId;
...
JLabel heading = new JLabel("Update Employeee Detail");
...
JLabel lblnagrita = new JLabel();
lblnagrita.setBounds(600, 350, 150, 30);
add(lblnagrita);
...
tfnagrita.setText(rs.getString("nagrita"));
